...
export function AmountField({
  ...
  return (
    <div className="flex items-center gap-3 bg-[#121212]/4 rounded-full p-2 h-16">
      ...
      {onMax && (
        <button
          type="button"
          onClick={onMax}
          className="shrink-0 bg-[#121212] text-[#fafafa] rounded-full px-4 h-10 text-sm font-bold outline-none active:scale-95 transition-transform cursor-pointer"
        >
          MAX
        </button>
      )}
