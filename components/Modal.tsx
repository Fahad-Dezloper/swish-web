      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed z-50 bg-[#fafafa] rounded-t-3xl md:rounded-3xl w-full max-w-[430px] bottom-0 left-1/2 -translate-x-1/2 md:bottom-auto md:top-1/2 md:-translate-y-1/2 overflow-hidden"
          >
