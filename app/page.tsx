            ...
            {!authenticated ? (
              ...
              >
                ...
                <motion.button
                  onClick={login}
                  whileTap={{ scale: 0.98 }}
                  className="w-full max-w-[280px] h-11 bg-[#121212] rounded-full flex items-center justify-center text-[#fafafa] font-semibold cursor-pointer shadow-[0_4px_12px_rgba(18,18,18,0.15)]"
                >
                  Get started
                </motion.button>
              </motion.div>
